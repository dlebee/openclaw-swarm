...
// envSuffixFromPrefix turns "it-phases-a3f17b" into "IT_PHASES_A3F17B"
// — a legal POSIX-ish env-var name component. We uppercase and
// swap '-' for '_' so the resulting TokenEnv (e.g.
// TELEGRAM_MAIN_BOT_TOKEN_IT_PHASES_A3F17B) is unambiguous in the
// env_file and can never shadow a real token the developer might have
